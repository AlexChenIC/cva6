...
# Accept both the legacy trace format and the cycle-prefixed cook.py format.
LINE_PREFIX_RE = r"[ \t]*(?:\d+[ \t]*\|[ \t]*)?"
...
def read_verilator_trace(path, full_trace):
  ...
  end_trampoline_re = re.compile(LINE_PREFIX_RE + r'core.*: 0x0000000080000000 ')
  start_debug_it_re = re.compile(LINE_PREFIX_RE + r'core.*: 0x0000000000000800 ')
  stop_debug_it_re  = re.compile(LINE_PREFIX_RE + r'core.*: 0x0000000000000890 ')
