...
"""Collect CI run/job data from GitHub API for the CVA6 CI Dashboard.
...
WORKFLOWS = {
    "ci": "ci.yml",
    "openhw-apu-full": "openhw-apu-full.yml",
    "openhw-quick-regress": "openhw-quick-regress.yml",
}
...
def main():
    parser = argparse.ArgumentParser(description="Collect CVA6 CI data from GitHub API")
    parser.add_argument(
        "--repo",
