...
"""Generate CVA6 CI Dashboard HTML from collected JSON data.
...
WORKFLOW_INFO = [
    ...
    {
        "key": "openhw-apu-full",
        "display_name": "openhw-apu-full",
        "file": "runs_openhw-apu-full.json",
    },
    {
        "key": "openhw-quick-regress",
        "display_name": "openhw-quick-regress",
        "file": "runs_openhw-quick-regress.json",
    },
]
...
MATRIX_SUITES_ORDER = [
    ...
    "dv-csr-embedded-tests",
    "dv-riscv-mmu-sv32-test",
]
...
def main():
    ...
    # Pick the best default workflow for the matrix
    # (prefer apu-full since it has the most coverage)
    default_matrix_wf = "openhw-apu-full"
    if not all_data.get("openhw-apu-full"):
        for wf in WORKFLOW_INFO:
