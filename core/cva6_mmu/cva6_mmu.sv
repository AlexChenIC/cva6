...
#(
    ...
    output logic lsu_is_store_o,  // access type associated with the translation response
    output logic [CVA6Cfg.VLEN-1:0] lsu_vaddr_o,  // virtual address associated with the response
